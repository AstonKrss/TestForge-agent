...
def show_menu():
    ...
    print()
    print("  常用示例:")
    print("    帮我测试一下 http://example.com 这个网站")
    print("    对 http://example.com 进行全部功能测试，并生成报告")
    print("    测试登录功能 账号是admin 密码是********")
    print("    生成测试用例 / 生成缺陷 / 生成JMeter脚本 http://example.com 线程10 循环20")
    print("    进入 CLI 后输入 help 可以查看完整教程")
    print()
    print("  0. 退出")
    print()
